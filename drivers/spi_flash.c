...
/*#define ra_dbg(args...)*/
#define ra_dbg(args...) do { if (0) printf(args); } while(0)
...
static struct chip_info chips_data [] = {
	...
	{ "W25Q128BV",		0xef, 0x40180000, 64 * 1024, 256,  0 }, //W25Q128BV
	{ "W25Q256FV",		0xef, 0x40190000, 64 * 1024, 512, 1 },
	{ "GD25Q64B",		0xc8, 0x4017c840, 64 * 1024, 128,  0 },
	{ "GD25Q32B",		0xc8, 0x4016c840, 64 * 1024, 64,  0 }, 
	{ "GD25Q16B",		0xc8, 0x4015c840, 64 * 1024, 32,  0 }, 
};
...
int do_flerase (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	...
	{
		printf("\n Erase u-boot-env and configs !!\n");
		printf("From 0x%X length 0x%X\n",CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE,
				CFG_CONFIG_SIZE);
		raspi_unprotect();
		rcode = raspi_erase(CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE,
				CFG_CONFIG_SIZE);
		return rcode;
	}
