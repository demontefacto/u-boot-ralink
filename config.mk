...
###############################################
ifeq ($(HG255D_BOARD),y)
CPPFLAGS += -DHG255D_BOARD
endif

ifeq ($(HG256_BOARD),y)
CPPFLAGS += -DHG256_BOARD
endif

ifeq ($(RT_N13U_BOARD),y)
CPPFLAGS += -DRT_N13U_BOARD
endif

ifeq ($(ZBT_AP8100RT_BOARD),y)
CPPFLAGS += -DAP8100RT_BOARD
endif

ifeq ($(ZBT_AP8101RT_BOARD),y)
CPPFLAGS += -DZBT_AP8101RT_BOARD
endif

ifeq ($(ZBT_AP8102RT_BOARD),y)
CPPFLAGS += -DZBT_AP8102RT_BOARD
endif

ifeq ($(ZBT_WR83052RT_BOARD),y)
CPPFLAGS += -DZBT_WR83052RT_BOARD
endif

ifeq ($(ZBT_WR8305RT_BOARD),y)
CPPFLAGS += -DZBT_WR8305RT_BOARD
endif

ifeq ($(BL_RT3052_BOARD),y)
CPPFLAGS += -DBL_RT3052_BOARD
endif

ifeq ($(AP2001_BOARD),y)
CPPFLAGS += -DAP2001_BOARD
endif

ifeq ($(WCR_GN_BOARD),y)
CPPFLAGS += -DWCR_GN_BOARD
endif

ifeq ($(FON2405E_BOARD),y)
CPPFLAGS += -DFON2405E_BOARD
endif

ifeq ($(WAP120NF_BOARD),y)
CPPFLAGS += -DWAP120NF_BOARD
endif

ifeq ($(FWR601_BOARD),y)
CPPFLAGS += -DFWR601_BOARD
endif

ifeq ($(MW305R_BOARD),y)
CPPFLAGS += -DMW305R_BOARD
endif

ifeq ($(DIR_620_BOARD),y)
CPPFLAGS += -DDIR_620_BOARD
endif

ifeq ($(AP7620A_BOARD),y)
CPPFLAGS += -DAP7620A_BOARD
CPPFLAGS += -DREDWAVE_BOARD
endif

ifeq ($(RY1_BOARD),y)
CPPFLAGS += -PRY1_BOARD
CPPFLAGS += -DDTEAM_BOARD
endif
...
ifeq ($(MT_WR856N),y)
CPPFLAGS += -DWR856N_BOARD
endif

ifeq ($(PBX220_BOARD),y)
CPPFLAGS += -DPBX220_BOARD
CPPFLAGS += -DSPEEDYTEL_BOARD
endif

ifeq ($(PBX230_BOARD),y)
CPPFLAGS += -DPBX230_BOARD
CPPFLAGS += -DSPEEDYTEL_BOARD
endif

ifeq ($(MT7620A_EVB_BOARD),y)
CPPFLAGS += -DMT7620A_EVB_BOARD
endif

ifeq ($(BR100_BOARD),y)
CPPFLAGS += -DBR100_BOARD
endif

ifeq ($(M100_BOARD),y)
CPPFLAGS += -DM100_BOARD
endif

ifeq ($(UNKNOW_BOARD),y)
CPPFLAGS += -DUNKNOW_BOARD
endif

ifeq ($(TTY_115200),y)
CPPFLAGS += -DTTY_115200
endif
ifeq ($(TTY_57600),y)
CPPFLAGS += -DTTY_57600
endif
...
ifeq ($(WEB_LANG_EN),y)
CPPFLAGS += -DWEB_LANG_EN
endif
ifeq ($(WEB_LANG_CN),y)
CPPFLAGS += -DWEB_LANG_CN
endif
...
ifeq ($(MEMORY_DETECT),y)
CPPFLAGS += -DMEMORY_DETECT
endif
