...
typedef struct {
	char	name[20];		/* flash name 				*/
	ulong	size;			/* total bank size in bytes		*/
	ushort	sector_count;		/* number of erase units		*/
	ulong	block_size;		/* number of erase units		*/
	ulong	flash_id;		/* combined device & manufacturer code	*/
	ulong	flash_id2;		/* combined device & manufacturer code2	*/
	ulong	flash_id3;		/* combined device & manufacturer code2	*/
...
#define MX_ID_29LV640ET 0x000022C9	/* 29LV640ET (64M, bottom boot sect) */
...
#define FLASH_S29GL128N 0x227E		/* Spansion S29GL128N			*/
#define FLASH_S29GLXXXN 0x227E		/* Spansion S29GL128N			*/
