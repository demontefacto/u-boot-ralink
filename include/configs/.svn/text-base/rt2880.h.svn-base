...
#if defined (TTY_115200) 
#define CONFIG_BAUDRATE		115200
#elif defined (TTY_57600)
#define CONFIG_BAUDRATE		57600
#elif defined (TTY_38400)
...
#elif ( defined (RT5350_ASIC_BOARD) || defined (RT3052_ASIC_BOARD) || defined (RT3352_ASIC_BOARD) || defined (RT3352_ASIC_BOARD) ) && defined (CFG_ENV_IS_IN_SPI)
#define	CFG_LOAD_ADDR		0x80220000	/* default load address	*/
#define CFG_HTTP_DL_ADDR	0x80400000
...
#else
//hg255d
#if defined(HG255D_BOARD) || defined(AP8100RT_BOARD)  /* HG255D AP8100RT use 16MB flash,flash Block is 128K */
#define CFG_BOOTLOADER_SIZE	0x40000
#define CFG_CONFIG_SIZE		0x20000
#define CFG_FACTORY_SIZE	0x20000
#elif defined(BR100_BOARD)  /* BR100 has u-boot part Ϊ128k,firmware is started x40000 */
#define CFG_BOOTLOADER_SIZE	0x20000
#define CFG_CONFIG_SIZE		0x10000
